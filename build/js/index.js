window.addEventListener("DOMContentLoaded", () => {
	...
	const posterContainer = [
		...document.querySelectorAll(".poster__container"),
	];
	const posterItem = posterContainer[0].firstElementChild;
	const posterBtnLeft = [
		...document.querySelectorAll(".poster #js-btn-left"),
	];
	const posterBtnRight = [
		...document.querySelectorAll(".poster #js-btn-right"),
	];
